...
# Form implementation generated from reading ui file 'dio_adc.ui'
#
...
class Ui_stack(object):
    def setupUi(self, stack):
        ...
        self.adcPage = QtWidgets.QWidget()
        self.adcPage.setObjectName("adcPage")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.adcPage)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setSpacing(0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.slider = QtWidgets.QSlider(self.adcPage)
        self.slider.setEnabled(False)
        self.slider.setMaximum(1023)
        self.slider.setOrientation(QtCore.Qt.Horizontal)
        self.slider.setObjectName("slider")
        self.horizontalLayout_2.addWidget(self.slider)
        self.lcdNumber = QtWidgets.QLCDNumber(self.adcPage)
        ...
        self.pushButton_3 = QtWidgets.QPushButton(self.adcPage)
        self.pushButton_3.setObjectName("pushButton_3")
        self.horizontalLayout_2.addWidget(self.pushButton_3)
        stack.addWidget(self.adcPage)
        ...
        self.pushButton_3.clicked.connect(stack.next) # type: ignore
        self.pullup.clicked['bool'].connect(stack.setOutputState) # type: ignore
        self.pushButton.clicked.connect(stack.next) # type: ignore
        self.slider.valueChanged['int'].connect(self.lcdNumber.display) # type: ignore
    ...
    def retranslateUi(self, stack):
        ...
        self.pushButton_3.setText(_translate("stack", "ADC"))
from . import res_rc
