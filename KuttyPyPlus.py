...
class AppWindow(QtWidgets.QMainWindow, layout.Ui_MainWindow):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        self.shortcuts = {"f": partial(self.setLanguage, 'fr_FR'), "e": partial(self.setLanguage, 'en_IN'),
                          "m": partial(self.setLanguage, 'ml_IN'), "Ctrl+S":self.saveFile, "Ctrl+O":self.openFile, "Ctrl+Shift+S":self.saveAs, "Ctrl+N":self.addSourceTab }
    ...
    def openFile(self):
        ...
        if len(filename[0]):
            ...
            self.activeEditor.setPlainText(infile.read()) #self.activeEditor = self.sourceTabs[self.activeSourceTab][0]
            infile.close()
